...
def main_loop():
    ...
    running = True
    while running:
        # Begræns billedhastigheden og få delta-tid til glidende panorering.
        ...
        # Tastaturpanorering (WASD + piletaster), skaleret efter zoomniveau og forløbet tid.
        ...
        # Automatisk zoom pr. frame omkring centrum med et fast antal iterationer.
        ...
        rotated_color_image = np.rot90(colorize(iteration_counts, max_iterations))   # Rotér til pygame.
